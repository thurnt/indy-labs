                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="project-title-input" name="title" placeholder="Enter project title" value="<?= $data['title'] ?? '' ?>">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Project Summary</label>
                                            <textarea name="summary" class="form-control" id="" cols="30" rows="4" placeholder="Enter project summary"><?= $data['summary'] ?? '' ?></textarea>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Project Description</label>
                                            <div id="ckeditor-classic"><?= $data['description'] ?? '' ?></div>
                                            <input type="hidden" name="description" id="project-description" value="<?= $data['description'] ?? '' ?>">
                                        </div>
                                    </div>
                                    <!-- end card body -->
                                </div>
                                ...
                                <div class="text-start mb-4">
                                    ...
                                    <button type="submit" class="btn btn-success w-sm"><?= isset($data['id']) ? 'Update' : 'Create' ?>
                                    </button>
                                </div>
                            </div>
                            <!-- end col -->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" data-choices data-choices-sorting-false data-choices-search-false id="choices-priority-input" name="priority" value="<?= $data['priority'] ?? '' ?>">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" data-choices data-choices-sorting-false data-choices-search-false id="choices-status-input" name="status" value="<?= $data['status'] ?? '' ?>">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="datepicker-deadline-input" placeholder="Enter due date" data-provider="flatpickr" name="deadline" data-date-format="d/m/Y" data-deafult-date="<?= isset($data['deadline']) ? date('d/m/Y', strtotime($data['deadline'])) : date('d/m/Y') ?>">
                                        </div>
                                    </div>
                                    <!-- end card body -->
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" data-choices data-choices-sorting-false data-choices-search-false id="choices-categories-input" name="category" value="<?= $data['category'] ?? '' ?>">
                                        ...
                                        <div>
                                            ...
                                            <input class="form-control" id="choices-text-input" data-choices data-choices-limit="Required Limit" placeholder="Enter Tags" type="text" value="<?= $data['tags'] ?? '' ?>" name="tags" />
                                        </div>
                                    </div>
                                    <!-- end card body -->
                                </div>
