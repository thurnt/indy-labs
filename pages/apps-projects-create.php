        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <form action="<?= home_url('project/new') ?>" method="post">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="project-title-input" name="title" placeholder="Enter project title">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Project Summary</label>
                                            <textarea name="summary" class="form-control" id="" cols="30" rows="4" placeholder="Enter project summary"></textarea>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="mb-3 mb-lg-0">
                                                    ...
                                                    <select class="form-select" data-choices data-choices-search-false id="choices-priority-input" name="priority">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3 mb-lg-0">
                                                    ...
                                                    <select class="form-select" data-choices data-choices-search-false id="choices-status-input" name="status">
                                            ...
                                            <div class="col-lg-4">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="datepicker-deadline-input" placeholder="Enter due date" data-provider="flatpickr" name="deadline" data-date-format="d/m/Y" data-deafult-date="<?= date('d/m/Y') ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div>
                                            <label for="choices-privacy-privacy-input" class="form-label">Privacy</label>
                                            <select class="form-select" data-choices data-choices-search-false id="choices-privacy-privacy-input" name="privacy">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" data-choices data-choices-search-false id="choices-categories-input" name="category">
                                        ...
                                        <div>
                                            ...
                                            <input class="form-control" id="choices-text-input" data-choices data-choices-limit="Required Limit" placeholder="Enter Skills" type="text" value="" name="tags" />
                                        </div>
                                    </div>
                                    <!-- end card body -->
                                </div>
