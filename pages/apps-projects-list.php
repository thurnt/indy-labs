                                    ...
                                    <div class="card-body">
                                        <div class="d-flex flex-column h-100">
                                            ...
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-1 fs-16"><a href="apps-projects-overview.php" class="text-body"><?= $item['title'] ?></a></h5>
                                            ...
                                            <div class="mt-auto">
                                                <div class="d-flex mb-2">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div><i class="ri-list-check align-bottom me-1 text-muted"></i> 18/42
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="mt-auto">
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <div><i class="ri-list-check align-bottom me-1 text-muted"></i> 22/56
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="progress progress-sm animated-progress">
                                                <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="54" aria-valuemin="0" aria-valuemax="100" style="width: 54%;"></div>
                                                <!-- /.progress-bar -->
                                            </div><!-- /.progress -->
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="text-muted text-truncate-two-lines mb-3">Create a Chat application
                                                    for business messaging needs. Collaborate efficiently with secure direct
                                                    messages and group chats.</p>
                                            </div>
                                        </div>
                                        <div class="mt-auto">
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <div><i class="ri-list-check align-bottom me-1 text-muted"></i> 14/20
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="progress progress-sm animated-progress">
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="mt-auto">
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <div><i class="ri-list-check align-bottom me-1 text-muted"></i> 20/34
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="progress progress-sm animated-progress">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-danger-subtle rounded-top">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="mb-0 fs-15"><a href="apps-projects-overview.php" class="text-body">Multipurpose landing
                                                        template</a></h5>
                                            </div>
                                            <div class="flex-shrink-0">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <div class="progress progress-sm animated-progress">
                                            <div class="progress-bar bg-info" role="progressbar" aria-valuenow="41" aria-valuemin="0" aria-valuemax="100" style="width: 41%;"></div>
                                            <!-- /.progress-bar -->
                                        </div><!-- /.progress -->
                                    </div>
                        ...
                        <div class="col-xxl-3 col-sm-6 project-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="py-3">
                                        <h5 class="fs-15 mb-3"><a href="apps-projects-overview.php" class="text-body">Kanban
                                                Board</a></h5>
                                        <div class="row gy-3">
                                            <div class="col-6">
                                                <div>
                        ...
                        <div class="col-xxl-3 col-sm-6 project-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="py-3">
                                        <h5 class="mb-3 fs-15"><a href="apps-projects-overview.php" class="text-body">Ecommerce
                                                app</a></h5>
                                        <div class="row gy-3">
                                            <div class="col-6">
                                                <div>
                        ...
                        <div class="col-xxl-3 col-sm-6 project-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="py-3">
                                        <h5 class="mb-3 fs-15"><a href="apps-projects-overview.php" class="text-body">Redesign
                                                - Landing page</a></h5>
                                        <div class="row gy-3">
                                            <div class="col-6">
                                                <div>
                        ...
                        <div class="col-xxl-3 col-sm-6 project-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="py-3">
                                        <h5 class="mb-3 fs-15"><a href="apps-projects-overview.php" class="text-body">Multipurpose
