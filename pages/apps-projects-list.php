            ...
            <div class="container-fluid">
                ...
                <div class="row g-4 mb-3">
                    <div class="col-sm-auto">
                        <div>
                            <a href="<?= home_url('project/new') ?>" class="btn btn-success"><i
                                        ...
                                        <div class="d-flex mb-2">
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-16"><a
                                                            href="<?= home_url('project/edit/' . $item['id']) ?>"
                                                            class="text-body"><?= $item['title'] ?></a>
                                                </h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="progress progress-sm animated-progress">
                                        <div class="progress-bar bg-info" role="progressbar" aria-valuenow="41"
