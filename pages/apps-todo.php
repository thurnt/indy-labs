                        ...
                        <div class="p-4 d-flex flex-column h-100">
                            <div class="mb-3">
                                <button class="btn btn-success w-100" data-bs-target="#createProjectModal"
                                        data-bs-toggle="modal"><i class="ri-add-line align-bottom"></i> Add Project
                                </button>
                            </div>
                            ...
                            <div class="px-4 mx-n4" data-simplebar style="height: calc(100vh - 468px);">
                                <ul class="to-do-menu list-unstyled" id="projectlist-data">
                                    <li>
                                        <a data-bs-toggle="collapse" href="#velzonAdmin" class="nav-link fs-14 active">Velzon
                                            Admin & Dashboard</a>
                                    ...
                                    <li>
                                        <a data-bs-toggle="collapse" href="#projectManagement" class="nav-link fs-14">Project
                                            Management</a>
                                    ...
                                    <li>
                                        <a data-bs-toggle="collapse" href="#ecommerceProject" class="nav-link fs-14">Doot
                                            - Chat App Template</a>
                ...
                <form autocomplete="off" class="needs-validation createProject-form" novalidate>
                    ...
                    <div class="hstack gap-2 justify-content-end">
                        <button type="button" class="btn btn-ghost-success" data-bs-dismiss="modal"><i
                                    class="ri-close-line align-bottom"></i> Close
                        </button>
        ...
        <div class="modal-content border-0">
            ...
            <div class="modal-body">
                ...
                <form autocomplete="off" action="" id="creattask-form">
                    ...
                    <div class="hstack gap-2 justify-content-end">
                        <button type="button" class="btn btn-ghost-success" data-bs-dismiss="modal"><i
                                    class="ri-close-fill align-bottom"></i> Close
                        </button>
