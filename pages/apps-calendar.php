                                ...
                                <div class="card card-h-100">
                                    <div class="card-body">
                                        <button class="btn btn-primary w-100" id="btn-new-event"><i
                                                    class="mdi mdi-plus"></i> Create New Event
                                        </button>
                                    ...
                                    <div class="card-body bg-info-subtle">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="text-muted mb-0">Event that applications book will appear
                                                    here. Click on an event to see the details and manage applicants
                                                    event.</p>
                                            </div>
                                        </div>
                                    </div>
...
<!-- calendar min js -->
<script src="<?= assets_url("libs/fullcalendar/index.global.min.js") ?>"></script>

<!-- Calendar init -->
<script src="<?= assets_url("js/pages/calendar.init.js") ?>"></script>
